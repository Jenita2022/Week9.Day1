...
public class LearnExtentReports {
	...
	public static void main(String[] args) throws IOException {
		...
		test.fail("Enter password"); // if i use fail(), then test will be treated as failed
		//capture screenshot for step
		test.pass("Click Login button",	MediaEntityBuilder.createScreenCaptureFromPath(".././testData/desktop.png").build());

		// step6: Mandatory step - to generte report
		extent.flush();
